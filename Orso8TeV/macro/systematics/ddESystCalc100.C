...
//// METUp
F0Up.push_back(0.003650892);	FlUp.push_back(-0.00518708);	FrUp.push_back(-4.6381e-04);
//// puUp
F0Up.push_back(0.00141679);	FlUp.push_back(-0.00139882);	FrUp.push_back(-1.79737e-05);
//// Q2Up
F0Up.push_back(0.0063273);	FlUp.push_back(-0.0106061);	FrUp.push_back(0.00427885);
//// ttUp
F0Up.push_back(0.00315078);	FlUp.push_back(-0.00337282);	FrUp.push_back(0.00022204);
//// tUp
...
//// ewknormUp
F0Up.push_back(-0.00300365);	FlUp.push_back(-0.00604876);	FrUp.push_back(9.05241e-03);
//// cwshapeUp
F0Up.push_back(-0.00769511);	FlUp.push_back(0.00842977);	FrUp.push_back(-0.000734657);
//// bwshapeUp
F0Up.push_back(-0.00034594);	FlUp.push_back(0.00411298);	FrUp.push_back(-3.76704e-03);
//// generatorUp
F0Up.push_back(-0.01003563);	FlUp.push_back(0.00628581);	FrUp.push_back(3.74982e-03);
...
//// METDown
F0Down.push_back(0.00648819);	FlDown.push_back(-0.00755564);	FrDown.push_back(-9.325451e-04);
//// puDown
F0Down.push_back(-0.00131229);	FlDown.push_back(0.0012771);	FrDown.push_back(3.51845e-05);
//// Q2Down
F0Down.push_back(0.00153403);	FlDown.push_back(-0.00585404);	FrDown.push_back(0.00432);
//// ttDown
F0Down.push_back(0.00051104);	FlDown.push_back(-0.00067232);	FrDown.push_back(0.000161279);
//// tDown
...
//// ewknormDown
F0Down.push_back(0.00247096);	FlDown.push_back(0.00609159);	FrDown.push_back(-8.56255e-03);
//// cwshapeDown
F0Down.push_back(-0.00393963);	FlDown.push_back(0.00431853);	FrDown.push_back(-0.000378907);
//// bwshapeDown
F0Down.push_back(0.0005297);	FlDown.push_back(-0.0049145);	FrDown.push_back(4.3848e-03);
//// generatorDown
F0Down.push_back(-0.01003563);	FlDown.push_back(0.00628581);	FrDown.push_back(3.74982e-03);
