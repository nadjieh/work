...
//// JERUp
F0Up.push_back(0.00249455);	FlUp.push_back(-0.001722896);	FrUp.push_back(0.004217446);
//// JERUp
F0Up.push_back(0.00246757);	FlUp.push_back(-0.00389725);	FrUp.push_back(-0.002570315);
//// lumiUp
F0Up.push_back(-0.00197944);	FlUp.push_back(0.00015158);	FrUp.push_back(-0.002172135);
//// massUp
F0Up.push_back(-5.76057e-06);	FlUp.push_back(-3.95593e-05);	FrUp.push_back(4.53198e-05);
//// METUp
F0Up.push_back(-0.000934854);	FlUp.push_back(0.004932477);	FrUp.push_back(-3.99762267e-03);
//// puUp
...
//// ewknormUp
F0Up.push_back(0.00200036966);	FlUp.push_back(0.005000308046);	FrUp.push_back(0.006999938384);
//// qcdnormUp
F0Up.push_back(-0.0225277);	FlUp.push_back(-0.0257308);	FrUp.push_back(-0.03520315);
//// cwshapeUp
F0Up.push_back(-0.00715098);	FlUp.push_back(0.00407271);	FrUp.push_back(3.078271e-03);
//// bwshapeUp
F0Up.push_back(-0.00197128);	FlUp.push_back(0.00205466);	FrUp.push_back(-8.33822e-05);
//// generatorUp
F0Up.push_back(-0.00626857);	FlUp.push_back(0.00619966);	FrUp.push_back(6.89139e-05);
...
//// JERDown
F0Down.push_back(-0.002757236);	FlDown.push_back(-0.001238998);	FrDown.push_back(3.9962342e-03);
//// JERDown
F0Down.push_back(-0.00150915);	FlDown.push_back(0.00362877);	FrDown.push_back(-0.000119617+0.002);
//// lumiDown
F0Down.push_back(0.00223208);	FlDown.push_back(-0.00043027);	FrDown.push_back(0.002198192);
//// massDown
F0Down.push_back(0.00450913);	FlDown.push_back(0.00471832);	FrDown.push_back(0.00922745);
//// METDown
F0Down.push_back(-0.00510178);	FlDown.push_back(0.00912122);	FrDown.push_back(1.880383e-03);
//// puDown
...
//// ewknormDown
F0Down.push_back(0.002000369662);	FlDown.push_back(0.005000308046);	FrDown.push_back(-0.007);
//// ewknormDown
F0Down.push_back(0.0192848);	FlDown.push_back(0.0220691);	FrDown.push_back(0.03478437);
//// cwshapeDown
F0Down.push_back(0.005980939);	FlDown.push_back(-0.00335122);	FrDown.push_back(-1.629721e-03);
//// bwshapeDown
F0Down.push_back(0.00195376);	FlDown.push_back(-0.00203068);	FrDown.push_back(7.69223e-05);
//// generatorDown
F0Down.push_back(-0.00626857);	FlDown.push_back(0.00619966);	FrDown.push_back(6.89139e-05);
