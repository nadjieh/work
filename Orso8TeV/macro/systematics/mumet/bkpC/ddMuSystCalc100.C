...
//// massUp
F0Up.push_back(-0.00931978);	FlUp.push_back(0.00687087);	FrUp.push_back(0.0024489);
//// METUp
...
//// Q2Up
F0Up.push_back(-0.000179923);	FlUp.push_back(-5.62661e-05);	FrUp.push_back(0.000236189);
//// ttUp
...
//// ewknormUp
F0Up.push_back(0.00681226);	FlUp.push_back(-0.00646536);	FrUp.push_back(-0.0003469);
//// cwshapeUp
F0Up.push_back(-0.00651045);	FlUp.push_back(0.00694913);	FrUp.push_back(-0.000438684);
//// bwshapeUp
F0Up.push_back(-0.00255953);	FlUp.push_back(0.00279614);	FrUp.push_back(-0.000236617);
//// generatorUp
F0Up.push_back(-0.00379925);	FlUp.push_back(0.00357208);	FrUp.push_back(0.000227171);
...
//// massDown
F0Down.push_back(0.0169237);	FlDown.push_back(-0.0164988);	FrDown.push_back(-0.000424832);
//// METDown
...
//// Q2Down
F0Down.push_back(0.00160701);	FlDown.push_back(-0.00355018);	FrDown.push_back(0.00194317);
//// ttDown
...
//// ewknormDown
F0Down.push_back(-0.00653664);	FlDown.push_back(0.0062014);	FrDown.push_back(0.000335246);
//// cwshapeDown
F0Down.push_back(-0.00528085);	FlDown.push_back(0.00546049);	FrDown.push_back(-0.000179641);
//// bwshapeDown
F0Down.push_back(0.0024717);	FlDown.push_back(-0.0026932);	FrDown.push_back(0.000221493);
//// generatorDown
F0Down.push_back(-0.00379925);	FlDown.push_back(0.00357208);	FrDown.push_back(0.000227171);
