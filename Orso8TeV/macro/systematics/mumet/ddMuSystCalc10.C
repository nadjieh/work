...
//// massUp
F0Up.push_back(-0.004066);	FlUp.push_back(0.00312461);	FrUp.push_back(-0.00094139);
//// METUp
F0Up.push_back(-0.00438959);	FlUp.push_back(0.00359763);	FrUp.push_back(-0.00079196);
//// puUp
F0Up.push_back(0.000987478);	FlUp.push_back(-7.60913e-05);	FrUp.push_back(-0.000911387);
//// Q2Up
F0Up.push_back(0.00288839);	FlUp.push_back(-0.00662463);	FrUp.push_back(-0.00373624);
//// ttUp
...
//// ewknormUp
F0Up.push_back(0.00309001);	FlUp.push_back(-0.0051578);	FrUp.push_back(-0.00206779);
//// cwshapeUp
F0Up.push_back(-0.00415366);	FlUp.push_back(0.00379672);	FrUp.push_back(-0.00035694);
//// bwshapeUp
F0Up.push_back(-0.00241116);	FlUp.push_back(0.00292972);	FrUp.push_back(-0.000518556);
//// generatorUp
F0Up.push_back(-0.00917591);	FlUp.push_back(0.00717926);	FrUp.push_back(-0.00199665);
...
//// massDown
F0Down.push_back(0.0080945);	FlDown.push_back(-0.0056004);	FrDown.push_back(0.0024941);
//// METDown
F0Down.push_back(-0.00498441);	FlDown.push_back(0.00500767);	FrDown.push_back(2.326e-05);
//// puDown
F0Down.push_back(-0.000665729);	FlDown.push_back(3.30697e-05);	FrDown.push_back(0.000632659);
//// Q2Down
F0Down.push_back(-0.00550965);	FlDown.push_back(0.00796228);	FrDown.push_back(0.00245263);
//// ttDown
...
//// ewknormDown
F0Down.push_back(-0.00266235);	FlDown.push_back(0.00481793);	FrDown.push_back(0.00215558);
//// cwshapeDown
F0Down.push_back(-0.00455779);	FlDown.push_back(0.00255977);	FrDown.push_back(-0.00199802);
//// bwshapeDown
F0Down.push_back(0.00228266);	FlDown.push_back(-0.00277209);	FrDown.push_back(0.000489428);
//// generatorDown
F0Down.push_back(-0.00917591);	FlDown.push_back(0.00717926);	FrDown.push_back(-0.00199665);
