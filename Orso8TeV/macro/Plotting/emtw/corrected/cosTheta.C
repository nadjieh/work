...
//=========  (Tue Aug 13 18:41:00 2013) by ROOT version5.32/00
   ...
   Default_allWcosTheta_stack_1->SetMaximum(3645.958);
   ...
   Default_allWcosTheta__3->SetBinContent(1,652.541);
   Default_allWcosTheta__3->SetBinContent(2,553.7748);
   Default_allWcosTheta__3->SetBinContent(3,674.6751);
   Default_allWcosTheta__3->SetBinContent(4,790.8298);
   Default_allWcosTheta__3->SetBinContent(5,776.3624);
   Default_allWcosTheta__3->SetBinContent(6,802.2204);
   Default_allWcosTheta__3->SetBinContent(7,858.7408);
   Default_allWcosTheta__3->SetBinContent(8,957.9954);
   Default_allWcosTheta__3->SetBinContent(9,952.8853);
   Default_allWcosTheta__3->SetBinContent(10,1010.171);
   Default_allWcosTheta__3->SetBinContent(11,1050.561);
   Default_allWcosTheta__3->SetBinContent(12,1045.596);
   Default_allWcosTheta__3->SetBinContent(13,1106.295);
   Default_allWcosTheta__3->SetBinContent(14,1120.961);
   Default_allWcosTheta__3->SetBinContent(15,1216.834);
   Default_allWcosTheta__3->SetBinContent(16,1240.15);
   Default_allWcosTheta__3->SetBinContent(17,1290.895);
   Default_allWcosTheta__3->SetBinContent(18,1362.505);
   Default_allWcosTheta__3->SetBinContent(19,1337.146);
   Default_allWcosTheta__3->SetBinContent(20,1485.814);
   Default_allWcosTheta__3->SetEntries(14217);
   ...
   Default_allWcosTheta->SetBinContent(1,2475.767);
   Default_allWcosTheta->SetBinContent(2,2013.593);
   Default_allWcosTheta->SetBinContent(3,2236.693);
   Default_allWcosTheta->SetBinContent(4,2460.283);
   Default_allWcosTheta->SetBinContent(5,2524.71);
   Default_allWcosTheta->SetBinContent(6,2683.969);
   Default_allWcosTheta->SetBinContent(7,2692.94);
   Default_allWcosTheta->SetBinContent(8,2774.251);
   Default_allWcosTheta->SetBinContent(9,2714.126);
   Default_allWcosTheta->SetBinContent(10,2821.963);
   Default_allWcosTheta->SetBinContent(11,2831.254);
   Default_allWcosTheta->SetBinContent(12,2744.967);
   Default_allWcosTheta->SetBinContent(13,2789.853);
   Default_allWcosTheta->SetBinContent(14,2732.063);
   Default_allWcosTheta->SetBinContent(15,2868.343);
   Default_allWcosTheta->SetBinContent(16,2752.449);
   Default_allWcosTheta->SetBinContent(17,2928.162);
   Default_allWcosTheta->SetBinContent(18,2879.857);
   Default_allWcosTheta->SetBinContent(19,3156.337);
   Default_allWcosTheta->SetBinContent(20,3472.341);
   Default_allWcosTheta->SetBinContent(21,0.286131);
   Default_allWcosTheta->SetBinError(1,60.93079);
   Default_allWcosTheta->SetBinError(2,51.69597);
   Default_allWcosTheta->SetBinError(3,55.52976);
   Default_allWcosTheta->SetBinError(4,59.7349);
   Default_allWcosTheta->SetBinError(5,56.52527);
   Default_allWcosTheta->SetBinError(6,64.94117);
   Default_allWcosTheta->SetBinError(7,60.54011);
   Default_allWcosTheta->SetBinError(8,62.30826);
   Default_allWcosTheta->SetBinError(9,59.08977);
   Default_allWcosTheta->SetBinError(10,68.85299);
   Default_allWcosTheta->SetBinError(11,69.2686);
   Default_allWcosTheta->SetBinError(12,72.18191);
   Default_allWcosTheta->SetBinError(13,74.52702);
   Default_allWcosTheta->SetBinError(14,78.16829);
   Default_allWcosTheta->SetBinError(15,89.99322);
   Default_allWcosTheta->SetBinError(16,93.32714);
   Default_allWcosTheta->SetBinError(17,108.3524);
   Default_allWcosTheta->SetBinError(18,124.8917);
   Default_allWcosTheta->SetBinError(19,157.1911);
   Default_allWcosTheta->SetBinError(20,199.342);
   Default_allWcosTheta->SetBinError(21,0.2088133);
   Default_allWcosTheta->SetEntries(319336.2);
   double x = 0;
   for(int p = 0; p<20; p++)
	x+= pow((Default_allWcosTheta->GetBinContent(p+1)-Default_allWcosTheta__14->GetBinContent(p+1)),2);

   cout<<x<<endl;
   
   TPaveStats *ptstats = new TPaveStats(0.3591954,0.8101266,0.5603448,0.9704641,"brNDC");
   ...
   text = ptstats->AddText("Entries = 319336 ");
   text = ptstats->AddText("Mean  = 0.05375");
   text = ptstats->AddText("RMS   = 0.5752");
