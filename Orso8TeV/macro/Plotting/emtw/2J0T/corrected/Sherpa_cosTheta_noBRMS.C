...
//=========  (Thu Nov 21 12:14:46 2013) by ROOT version5.32/00
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",435,105,700,502);
   Canvas_1->Range(-1.25,13507.46,1.25,38306.05);
   ...
   Default_allWcosTheta__3->SetBinContent(1,17273.9);
   Default_allWcosTheta__3->SetBinContent(2,16887.04);
   Default_allWcosTheta__3->SetBinContent(3,18886.6);
   Default_allWcosTheta__3->SetBinContent(4,20249.26);
   Default_allWcosTheta__3->SetBinContent(5,21740.26);
   Default_allWcosTheta__3->SetBinContent(6,22944.83);
   Default_allWcosTheta__3->SetBinContent(7,23382.18);
   Default_allWcosTheta__3->SetBinContent(8,23930.89);
   Default_allWcosTheta__3->SetBinContent(9,24947.65);
   Default_allWcosTheta__3->SetBinContent(10,25699.03);
   Default_allWcosTheta__3->SetBinContent(11,26468.41);
   Default_allWcosTheta__3->SetBinContent(12,27252.47);
   Default_allWcosTheta__3->SetBinContent(13,28127.78);
   Default_allWcosTheta__3->SetBinContent(14,28825.55);
   Default_allWcosTheta__3->SetBinContent(15,29088.84);
   Default_allWcosTheta__3->SetBinContent(16,29991.46);
   Default_allWcosTheta__3->SetBinContent(17,30819.32);
   Default_allWcosTheta__3->SetBinContent(18,32171.15);
   Default_allWcosTheta__3->SetBinContent(19,33979.89);
   Default_allWcosTheta__3->SetBinContent(20,34881.48);
   Default_allWcosTheta__3->SetEntries(342865);
