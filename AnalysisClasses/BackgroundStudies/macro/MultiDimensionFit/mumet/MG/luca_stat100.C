...
//=========  (Wed Dec 11 02:38:28 2013) by ROOT version5.32/00
   ...
   TEllipse *ellipse = new TEllipse(-0.001723519,0.005469464,0.07678276,0.01514569,0,360,-31.81735);
   ...
   graph->SetPoint(0,-0.00172351859,0.006010381306);
   ...
   ellipse = new TEllipse(-0.001723519,0.005469464,0.00891921,0.02975046,0,360,43.61363);
   ...
   ellipse = new TEllipse(-0.001913793,0.005204097,0.08185345,0.01896182,0,360,-33.59069);
   ellipse->SetFillStyle(0);
   ellipse->SetLineWidth(2);
   ellipse->Draw();
