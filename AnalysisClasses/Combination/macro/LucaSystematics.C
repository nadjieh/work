...
#include "../interface/OneDLucaSyst.h"
...
int main(int argc, char** argv) {
    ...
    double x[6] = {0.700701, 0.306839, 0., 0., 1., 1.00177};
    double xerr[6] = {-1., -1., -1., -1., -1.,};
    double correlation;
    ...
    std::pair<ROOT::Math::Functor, OneDLucaSyst*> myLL =
            OneDLucaSyst::getOneDLucaSystForSyst("LL", IDin7, IDin8);
    GetMinimumOneDLucaCombined(myLL.first, x, xerr, correlation, forHist, true);
