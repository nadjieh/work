...
//=========  (Tue Oct  1 18:43:03 2013) by ROOT version5.32/00
   ...
   e_Chi2Syst_correlated_res3D->SetMinimum(-72.77073);
   e_Chi2Syst_correlated_res3D->SetMaximum(6880.872);
   e_Chi2Syst_correlated_res3D->SetEntries(20);
   
   TPaveStats *ptstats = new TPaveStats(0.2869128,0.75,0.488255,0.910596,"brNDC");
   ...
   ptstats = new TPaveStats(0.2416107,0.75,0.442953,0.9089404,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   e_comb2_Components2_subtracted->SetMinimum(-72.77073);
   e_comb2_Components2_subtracted->SetMaximum(6880.872);
   ...
   TPaveText *pt = new TPaveText(0.25,0.8096026,0.5,0.8642384,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   ...
   ptstats = new TPaveStats(0.2348993,0.7566225,0.4362416,0.9155629,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   e_comb2_Components2_unfolded->SetMinimum(-72.77073);
   e_comb2_Components2_unfolded->SetMaximum(6880.872);
   ...
   ptstats = new TPaveStats(0.3120805,0.7566225,0.5134228,0.9155629,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   genSignal->SetMinimum(-72.77073);
   genSignal->SetMaximum(6880.872);
   ...
   ptstats = new TPaveStats(0.2768456,0.7698675,0.4781879,0.9288079,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
