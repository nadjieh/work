...
//=========  (Tue Oct  1 18:35:15 2013) by ROOT version5.32/00
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "c",369,85,600,632);
   Canvas_1->SetHighLightColor(2);
   Canvas_1->Range(-1.275862,-176582.8,1.022989,30258.88);
   ...
   e_Chi2Syst_correlated_res3D->SetMinimum(-155898.7);
   e_Chi2Syst_correlated_res3D->SetMaximum(21985.22);
   e_Chi2Syst_correlated_res3D->SetEntries(20);
   
   TPaveStats *ptstats = new TPaveStats(0.2516779,0.4917219,0.4530201,0.6523179,"brNDC");
   ...
   ptstats = new TPaveStats(0.2516779,0.4983444,0.4530201,0.6572848,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   e_comb2_Components2_subtracted->SetMinimum(-155898.7);
   e_comb2_Components2_subtracted->SetMaximum(21985.22);
   ...
   TPaveText *pt = new TPaveText(0.3204698,0.5513245,0.5704698,0.6059603,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   ...
   ptstats = new TPaveStats(0.2651007,0.5033113,0.466443,0.6622517,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   e_comb2_Components2_unfolded->SetMinimum(-155898.7);
   e_comb2_Components2_unfolded->SetMaximum(21985.22);
   ...
   ptstats = new TPaveStats(0.307047,0.4801325,0.5083893,0.6390728,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   genSignal->SetMinimum(-155898.7);
   genSignal->SetMaximum(21985.22);
   ...
   ptstats = new TPaveStats(0.2768456,0.4784768,0.4781879,0.6374172,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   component_2_meas->SetMinimum(-155898.7);
   component_2_meas->SetMaximum(21985.22);
   ...
   TLegend *leg = new TLegend(0.2147651,0.4122517,0.6543624,0.7019868,NULL,"brNDC");
   leg->SetBorderSize(1);
   leg->SetTextFont(62);
   leg->SetLineColor(0);
   leg->SetLineStyle(1);
