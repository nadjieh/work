...
//=========  (Tue Oct  1 18:46:04 2013) by ROOT version5.32/00
   ...
   e_Chi2Syst_correlated_res3D->SetMinimum(-126.6749);
   e_Chi2Syst_correlated_res3D->SetMaximum(6975.204);
   e_Chi2Syst_correlated_res3D->SetEntries(20);
   
   TPaveStats *ptstats = new TPaveStats(0.7869128,0.7649007,0.8775168,0.9254967,"brNDC");
   ...
   ptstats = new TPaveStats(0.7869128,0.763245,0.9228188,0.9221854,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   e_comb2_Components2_subtracted->SetMinimum(-126.6749);
   e_comb2_Components2_subtracted->SetMaximum(6975.204);
   ...
   TPaveText *pt = new TPaveText(0.6677852,0.8410596,0.9177852,0.8956954,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   ...
   ptstats = new TPaveStats(0.7785235,0.7764901,0.9161074,0.9354305,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   e_comb2_Components2_unfolded->SetMinimum(-126.6749);
   e_comb2_Components2_unfolded->SetMaximum(6975.204);
   ...
   ptstats = new TPaveStats(0.7785235,0.7764901,0.9110738,0.9354305,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   genSignal->SetMinimum(-126.6749);
   genSignal->SetMaximum(6975.204);
   ...
   ptstats = new TPaveStats(0.7785235,0.7764901,0.9144295,0.9354305,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   TLegend *leg = new TLegend(0.590604,0.7334437,0.9697987,0.9437086,NULL,"brNDC");
   leg->SetBorderSize(1);
   leg->SetTextFont(62);
   leg->SetLineColor(0);
   leg->SetLineStyle(1);
