...
//=========  (Mon Nov 11 18:41:46 2013) by ROOT version5.32/00
   TCanvas *Canvas_1_n2 = new TCanvas("Canvas_1_n2", "Canvas_1",311,82,700,502);
   Canvas_1_n2->Range(-1.25,60.86866,1.25,3725.052);
   ...
   TH1D *e_comb3_Components2_unfolded__1 = new TH1D("e_comb3_Components2_unfolded__1","",10,-1,1);
   e_comb3_Components2_unfolded__1->SetBinContent(1,580.5911);
   e_comb3_Components2_unfolded__1->SetBinContent(2,1454.019);
   e_comb3_Components2_unfolded__1->SetBinContent(3,2192.396);
   e_comb3_Components2_unfolded__1->SetBinContent(4,2749.505);
   e_comb3_Components2_unfolded__1->SetBinContent(5,3088.524);
   e_comb3_Components2_unfolded__1->SetBinContent(6,3172.356);
   e_comb3_Components2_unfolded__1->SetBinContent(7,2990.687);
   e_comb3_Components2_unfolded__1->SetBinContent(8,2438.001);
   e_comb3_Components2_unfolded__1->SetBinContent(9,1668.324);
   e_comb3_Components2_unfolded__1->SetBinContent(10,606.2884);
   e_comb3_Components2_unfolded__1->SetBinError(1,20.36314);
   e_comb3_Components2_unfolded__1->SetBinError(2,32.48923);
   e_comb3_Components2_unfolded__1->SetBinError(3,39.88482);
   e_comb3_Components2_unfolded__1->SetBinError(4,44.25266);
   e_comb3_Components2_unfolded__1->SetBinError(5,46.37319);
   e_comb3_Components2_unfolded__1->SetBinError(6,46.68986);
   e_comb3_Components2_unfolded__1->SetBinError(7,44.88151);
   e_comb3_Components2_unfolded__1->SetBinError(8,40.12301);
   e_comb3_Components2_unfolded__1->SetBinError(9,32.77651);
   e_comb3_Components2_unfolded__1->SetBinError(10,19.46213);
   e_comb3_Components2_unfolded__1->SetEntries(20940);
   e_comb3_Components2_unfolded__1->SetDirectory(0);
   ...
   ptstats->SetOptFit(0);
   ptstats->Draw();
   e_comb3_Components2_unfolded__1->GetListOfFunctions()->Add(ptstats);
   ptstats->SetParent(e_comb3_Components2_unfolded__1);
   e_comb3_Components2_unfolded__1->SetLineColor(9);
   e_comb3_Components2_unfolded__1->SetLineWidth(3);
   e_comb3_Components2_unfolded__1->GetXaxis()->SetLabelFont(42);
   e_comb3_Components2_unfolded__1->GetXaxis()->SetLabelSize(0.035);
   e_comb3_Components2_unfolded__1->GetXaxis()->SetTitleSize(0.035);
   e_comb3_Components2_unfolded__1->GetXaxis()->SetTitleFont(42);
   e_comb3_Components2_unfolded__1->GetYaxis()->SetLabelFont(42);
   e_comb3_Components2_unfolded__1->GetYaxis()->SetLabelSize(0.035);
   e_comb3_Components2_unfolded__1->GetYaxis()->SetTitleSize(0.035);
   e_comb3_Components2_unfolded__1->GetYaxis()->SetTitleFont(42);
   e_comb3_Components2_unfolded__1->GetZaxis()->SetLabelFont(42);
   e_comb3_Components2_unfolded__1->GetZaxis()->SetLabelSize(0.035);
   e_comb3_Components2_unfolded__1->GetZaxis()->SetTitleSize(0.035);
   e_comb3_Components2_unfolded__1->GetZaxis()->SetTitleFont(42);
   e_comb3_Components2_unfolded__1->Draw("");
   
   TH1D *genSignal__2 = new TH1D("genSignal__2","Default_allW: cos(#theta)",10,-1,1);
   genSignal__2->SetBinContent(1,542.9177);
   genSignal__2->SetBinContent(2,1436.394);
   genSignal__2->SetBinContent(3,2193.243);
   genSignal__2->SetBinContent(4,2750.222);
   genSignal__2->SetBinContent(5,3090.919);
   genSignal__2->SetBinContent(6,3193.526);
   genSignal__2->SetBinContent(7,3040.707);
   genSignal__2->SetBinContent(8,2516.767);
   genSignal__2->SetBinContent(9,1756.554);
   genSignal__2->SetBinContent(10,658.3411);
   genSignal__2->SetBinError(1,18.50227);
   genSignal__2->SetBinError(2,31.22065);
   genSignal__2->SetBinError(3,38.81437);
   genSignal__2->SetBinError(4,43.10006);
   genSignal__2->SetBinError(5,45.19815);
   genSignal__2->SetBinError(6,45.7306);
   genSignal__2->SetBinError(7,44.38019);
   genSignal__2->SetBinError(8,40.18998);
   genSignal__2->SetBinError(9,33.40265);
   genSignal__2->SetBinError(10,20.39917);
   genSignal__2->SetEntries(229809);
   ...
   CombinedChi2Syst_uncorrelated_7TeV_comb_signaltmpCombinedID->SetBinContent(1,1681.897);
