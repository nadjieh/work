...
//=========  (Mon Nov 11 21:21:03 2013) by ROOT version5.32/00
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "c",108,75,600,692);
   ...
   ptstats = new TPaveStats(0.2281879,0.7689769,0.4295302,0.9290429,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   ptstats = new TPaveStats(0.2348993,0.7755776,0.4362416,0.9356436,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   TH1D *component_1_meas = new TH1D("component_1_meas","",10,-1,1);
   component_1_meas->SetBinContent(1,1500.985);
   component_1_meas->SetBinContent(2,2591.677);
   component_1_meas->SetBinContent(3,2807.437);
   component_1_meas->SetBinContent(4,2576.545);
   component_1_meas->SetBinContent(5,2122.767);
   component_1_meas->SetBinContent(6,1578.179);
   component_1_meas->SetBinContent(7,1041.824);
   component_1_meas->SetBinContent(8,556.2766);
   component_1_meas->SetBinContent(9,215.9097);
   component_1_meas->SetBinContent(10,29.45308);
   component_1_meas->SetBinError(1,52.64422);
   component_1_meas->SetBinError(2,57.90955);
   component_1_meas->SetBinError(3,51.07384);
   component_1_meas->SetBinError(4,41.4689);
   component_1_meas->SetBinError(5,31.87266);
   component_1_meas->SetBinError(6,23.2272);
   component_1_meas->SetBinError(7,15.63474);
   component_1_meas->SetBinError(8,9.154834);
   component_1_meas->SetBinError(9,4.241842);
   component_1_meas->SetBinError(10,0.9454573);
   component_1_meas->SetEntries(18261.45);
   ...
   TLegend *leg = new TLegend(0.147651,0.7260726,0.5536913,0.9488449,NULL,"brNDC");
   leg->SetBorderSize(1);
   leg->SetTextFont(62);
