...
//=========  (Tue Oct  1 17:07:32 2013) by ROOT version5.32/00
   ...
   TPaveStats *ptstats = new TPaveStats(0.4295302,0.2256944,0.6308725,0.3854167,"brNDC");
   ...
   TPaveText *pt = new TPaveText(0.8171141,0.8246528,0.8506711,0.8836806,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   ...
   ptstats = new TPaveStats(0.4630872,0.1979167,0.6644295,0.3576389,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   ptstats = new TPaveStats(0.4295302,0.1944444,0.6308725,0.3541667,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   ptstats = new TPaveStats(0.4395973,0.1909722,0.6409396,0.3506944,"brNDC");
   ptstats->SetName("stats");
   ptstats->SetBorderSize(1);
   ptstats->SetFillColor(0);
   ptstats->SetTextAlign(12);
   ...
   text->SetTextSize(0.03673611);
   text = ptstats->AddText("Entries = 28319  ");
   text = ptstats->AddText("Mean  = -0.01361");
   text = ptstats->AddText("RMS   = 0.3744");
   ptstats->SetOptStat(1111);
   ptstats->SetOptFit(0);
   ptstats->Draw();
   
   TH1D *component_0_meas = new TH1D("component_0_meas","e_comb3_Components2SingleTopR",10,-1,1);
   component_0_meas->SetBinContent(1,189.6318);
   component_0_meas->SetBinContent(2,1275.169);
   component_0_meas->SetBinContent(3,2804.98);
   component_0_meas->SetBinContent(4,4073.88);
   component_0_meas->SetBinContent(5,4721.721);
   component_0_meas->SetBinContent(6,4774.625);
   component_0_meas->SetBinContent(7,3902.711);
   component_0_meas->SetBinContent(8,2523.576);
   component_0_meas->SetBinContent(9,1107.193);
   component_0_meas->SetBinContent(10,142.0048);
   component_0_meas->SetBinError(1,6.644521);
   component_0_meas->SetBinError(2,28.19547);
   component_0_meas->SetBinError(3,50.32101);
   component_0_meas->SetBinError(4,64.98974);
   component_0_meas->SetBinError(5,70.67506);
   component_0_meas->SetBinError(6,69.54878);
   component_0_meas->SetBinError(7,58.15616);
   component_0_meas->SetBinError(8,41.14799);
   component_0_meas->SetBinError(9,21.59763);
   component_0_meas->SetBinError(10,4.517173);
   component_0_meas->SetEntries(28319.45);
   ...
   TLegend *leg = new TLegend(0.3422819,0.1666667,0.7483221,0.3888889,NULL,"brNDC");
   leg->SetBorderSize(1);
   leg->SetTextFont(62);
