...
//Y: FL
	...
	//double sigL = sqrt(pow(0.038,2)+pow(0.0462822,2));
	//double sig0 = sqrt(pow(0.056,2)+pow(0.079313,2));
    double sigL = sqrt(pow(0.038,2)+pow(0.0566127,2));
	double sig0 = sqrt(pow(0.056,2)+pow(0.0940319,2));
	cout<<sigL<<"\t"<<sig0<<endl;
