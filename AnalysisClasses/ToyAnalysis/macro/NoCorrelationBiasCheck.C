...
int main(int argc, char** argv) {
    ...
    NoCorrelation3DLinearityChecker myBaseLinearityCheckerEle("myBaseLinearityChecker", prefix, suffix, histName, dirName,
            "electron", 10);
    ...
    NoCorrelation3DLinearityChecker myBaseLinearityCheckerMu("myBaseLinearityChecker", prefix, suffix, histName, dirName,
            "muon", 10);
