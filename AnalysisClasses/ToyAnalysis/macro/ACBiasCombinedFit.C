/* 
 * File:   ACBiasCombinedFit.C
 * Author: nadjieh
 *
 * Created on July 11, 2013, 4:46 PM
 */
...
int main(int argc, char** argv) {
    ...
    string prefixE = string(prefix + "TreesEle_");
    string prefixMu = string(prefix + "TreesMu_");


    cout << "Luminosity: " << Lumi << endl;
    ProductionBiasForCombination myProductionWtbMu("myCombinedBiasBaseChecker", "ElecPart", prefixMu, prefixE,
            suffix, histName, dirName, "emu", 300, 10);
