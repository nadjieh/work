#ifndef Lumi3DReWeighting_h
#define Lumi3DReWeighting_h
...
/**
   ...
   -- This is the Stand-Alone version that doesn't use ny CMS classes --
...
class Lumi3DReWeighting {
 public:
  ...
  double weight3D( TRootEvent* event);
  ...
  void setWFileName(std::string name){wFileName = name;}
