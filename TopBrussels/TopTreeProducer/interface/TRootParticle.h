...
namespace TopTree {
    ...
    public:
        ...
        Int_t genParticleIndex() const {
            return genParticleIndex_;
        }

        virtual TString typeName() const {
            return "TRootParticle";
        }
...
//            cout << "In method: " << charge << "\t";
            charge_ = charge;
//            cout << charge_ << endl;
        }

        void setGenParticleIndex(Int_t genParticleIndex) {
            genParticleIndex_ = genParticleIndex;
        }
