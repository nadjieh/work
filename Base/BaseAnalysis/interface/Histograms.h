...
public:
    ...
    void setName(string name){_CollectionName = name;};
    ...
    void AddHisto2();
    void AddHisto2(ObjectProperty<T>* op1,ObjectProperty<T>* op2);
...
template<class _T>
void Histograms<_T>::AddHisto2(ObjectProperty<_T>* op1,ObjectProperty<_T>* op2) {
    TH2Ext<_T> * h = op1->GetH2(op2, CollectionName(), _Title);
    th2s->push_back(*h);
